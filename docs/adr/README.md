...
ADRs preserve decisions beyond any one human or agent context window.

## Status

- **Accepted:** current default.
- **Superseded:** replaced by a newer ADR.
- **Experimental:** allowed only behind an explicit measurement/exit criterion.

## Index

- [0001 Monorepo and toolchain](0001-monorepo-toolchain.md)
- [0002 Rust, Axum, and Cloudflare Workers](0002-rust-axum-cloudflare-workers.md)
