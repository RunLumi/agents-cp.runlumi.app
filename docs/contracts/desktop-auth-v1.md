...
3. An authenticated browser opens the verification URI, confirms the device label, and calls `POST /api/v1/auth/device-code/approve` with the authorization ID.
