...
| P06   | implementation complete; visual pass owed | frozen: `p06-cg-v1` (`11341a5`, PR #22; CR-001/002/003 + ADR 0006) | PASS: all six claims mapped to named evidence           | 15 migrations, 48 routes mounted, 668 Rust + 445 web tests, hosted CI green. **Outstanding:** no P06 surface has been visually verified — no browser is attached to this session. `docs/screens/` also has no reference for these four surfaces                                                               |
