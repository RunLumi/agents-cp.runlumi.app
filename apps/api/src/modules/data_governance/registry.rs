...
const DEFINITIONS: &[Definition] = &[
    ...
    Definition {
        ...
        deletion: DeletionBehavior::Tombstone,
        logging: LoggingRule::StatusOnly,
        description: "Membership of a user in a team inside an organization.",
    },
    Definition {
        class: "project_access_grant",
        sensitivity: Sensitivity::Confidential,
        owner_scope: OwnerScope::Organization,
        retention: RetentionWindow::Lifecycle,
        legal_maximum: RetentionWindow::Lifecycle,
        ...
        deletion: DeletionBehavior::Tombstone,
        logging: LoggingRule::StatusOnly,
        description: "Restricted project-visibility grant issued to a user or role.",
    },
    Definition {
        class: "team",
        sensitivity: Sensitivity::Internal,
