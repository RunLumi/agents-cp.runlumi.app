/**
 * Webhook surface primitives.
 *
 * Local to `features/webhooks/**` because the design-system components are not
 * generated in this repository yet and `@/lib` is outside the P06-FE-02 write
 * surface. Tokens, radii, borders, and motion come from `DESIGN.md` and
 * `src/styles/globals.css`; nothing here introduces a new palette or style.
 */
